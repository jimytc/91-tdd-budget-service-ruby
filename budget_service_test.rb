...
class BudgetServiceTest < Minitest::Test
  ...
  def test_no_budget
    given_no_budget do
      when_period_starts from('20200401'), to('20200401') do
  ...
  def test_period_no_overlap_before_budget_first_day
    given_budgets Budget.new('202004', 30) do
      when_period_starts from('20200331'), to('20200331') do
        budget_should_be 0.0
      end
    end
  end
  ...
  def test_period_no_overlap_after_budget_last_day
    given_budgets Budget.new('202004', 30) do
      when_period_starts from('20200501'), to('20200501') do
        budget_should_be 0.0
      end
    end
  end
  ...
  def test_period_overlap_budget_last_day
    given_budgets Budget.new('202004', 30) do
      when_period_starts from('20200430'), to('20200501') do
        budget_should_be 1.0
      end
    end
  end
  ...
  def test_period_cross_budget_month
    given_budgets Budget.new('202004', 30) do
      when_period_starts from('20200331'), to('20200501') do
  ...
  def test_invalid_period
    given_budgets Budget.new('202004', 30) do
      when_period_starts from('20200430'), to('20200401') do
        budget_should_be 0.0
      end
    end
  end
  ...
  def test_daily_amount_10
    given_budgets Budget.new('202004', 300) do
      when_period_starts from('20200401'), to('20200402') do
  ...
  def test_multiple_budgets
    given_budgets Budget.new('202003', 310), Budget.new('202004', 30), Budget.new('202005', 3100) do
      when_period_starts from('20200330'), to('20200501') do
  ...
  def when_period_starts(start_date, end_date)
